...
// m_Graphics->drawTriangleGradient( 0.5f, 0.2f, 0.2f, 0.8f, 0.8f, 0.8f );
...
// m_Graphics->drawTriangleGradient( trianglePixelX, trianglePixelY, 0.2f, 0.8f, 0.8f, 0.8f ); 		// yet this is completely fine???
...
// TODO uncomment this after done testing triangle gradients
// 	/*
// 	m_Graphics->setColor( 1.0f, 1.0f, 1.0f );
// 
// 	static float x = 1.0f;
